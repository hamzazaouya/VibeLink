...
async function registerUser(user_id: IUser, firstName: string, lastName: string, age: number, gender:string, phone: string, bio: string, latitude: string, longitude: string, hobbies: string[], profileImage: any, images:any): Promise<void> {
